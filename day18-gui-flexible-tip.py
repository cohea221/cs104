...
win = graphics.GraphWin("Flexible Tip Calculator", 600, 600)

# draw the heading at the top  - MODIFY THE TEXT DISPLAYED
top_text=graphics.Text(graphics.Point(300,100), "Tip Calculator")
top_text.draw(win)
...
text2 = graphics.Text(graphics.Point(150,300), "Tip (as %):")
text2.draw(win)
